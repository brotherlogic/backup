...
type BackupFile struct {
	...
	DirectoryHash int32                  `protobuf:"varint,2,opt,name=directory_hash,json=directoryHash,proto3" json:"directory_hash,omitempty"`
	FilenameHash  int32                  `protobuf:"varint,3,opt,name=filename_hash,json=filenameHash,proto3" json:"filename_hash,omitempty"`
}
...
var file_backup_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x79, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d,
